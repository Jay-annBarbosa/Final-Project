...
if (isset($_GET['delete_order'])) {
	...
	echo "<script>window.open('ManageOrders.php','_self')</script>";
}
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-3 sidebar">
				...
				<a href="ManageOrders.php" class="active"><i class="fas fa-receipt"></i> Manage Orders</a>
			...
			<div class="col-md-9 main-content">
				<h1 class="page-title"><i class="fas fa-receipt"></i> Manage Orders</h1>
						...
						<tbody>
							...
							if (mysqli_num_rows($orders_result) > 0) {
								while ($order = mysqli_fetch_assoc($orders_result)) {
									...
									echo "<td>";
									echo "<button class='btn btn-custom view-btn' data-url='ViewOrder.php?order_id=" . $order['order_id'] . "&ajax=1'><i class='fas fa-eye'></i> View</button>";
									echo "<a href='ManageOrders.php?delete_order=" . $order['order_id'] . "' class='btn btn-custom btn-delete' onclick='return confirm(\"Are you sure?\")'><i class='fas fa-trash'></i> Delete</a>";
									echo "</td>";
									echo "</tr>";
								}
							} else {
