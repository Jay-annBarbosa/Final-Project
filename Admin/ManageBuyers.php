...
if (isset($_GET['delete_buyer'])) {
	$buyer_id = mysqli_real_escape_string($con, $_GET['delete_buyer']);
	$delete_query = "DELETE FROM buyerregistration WHERE buyer_id = '$buyer_id'";
	if (mysqli_query($con, $delete_query)) {
		$_SESSION['success_message'] = "Buyer deleted successfully!";
	} else {
		$_SESSION['error_message'] = "Error deleting buyer!";
	}
	echo "<script>window.open('ManageBuyers.php','_self')</script>";
}

// Get all buyers
$buyers_query = "SELECT * FROM buyerregistration ORDER BY buyer_id DESC";
...
<head>
	...
	<title>Manage Buyers - Admin Panel</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-3 sidebar">
				...
				<a href="ManageBuyers.php" class="active"><i class="fas fa-shopping-cart"></i> Manage Buyers</a>
			...
			<div class="col-md-9 main-content">
				<h1 class="page-title"><i class="fas fa-shopping-cart"></i> Manage Buyers</h1>
				...
				<div class="table-responsive table-custom">
					<table class="table table-hover">
						...
						<tbody>
							<?php
							if (mysqli_num_rows($buyers_result) > 0) {
								while ($buyer = mysqli_fetch_assoc($buyers_result)) {
									echo "<tr>";
									echo "<td>" . $buyer['buyer_id'] . "</td>";
									echo "<td>" . $buyer['buyer_name'] . "</td>";
									echo "<td>" . $buyer['buyer_phone'] . "</td>";
									echo "<td>" . $buyer['buyer_mail'] . "</td>";
									echo "<td>" . $buyer['buyer_comp'] . "</td>";
									echo "<td>" . $buyer['buyer_username'] . "</td>";
									echo "<td>";
									echo "<button class='btn btn-custom view-btn' data-url='ViewBuyer.php?buyer_id=" . $buyer['buyer_id'] . "&ajax=1'><i class='fas fa-eye'></i> View</button>";
									echo "<a href='ManageBuyers.php?delete_buyer=" . $buyer['buyer_id'] . "' class='btn btn-custom btn-delete' onclick='return confirm(\"Are you sure?\")'><i class='fas fa-trash'></i> Delete</a>";
									echo "</td>";
									echo "</tr>";
								}
							} else {
